...
public class BuscarPorMatricula extends VentanaPadre {
	 ...
	 * 
	 * @param matriculaCampo Campo de la matr&iacute;cula del coche.
	 * @param panelContenedor Panel que contiene los elementos de la ventana.
	 * @param marcaComboBox Lista de marcas.
	 * @param modeloComboBox Lista de modelos.
	 * @param colorAzul Bot&oacute;n para el color azul.
	 * @param colorPlata Bot&oacute;n para el color plata.
	 * @param colorRojo Bot&oacute;n para el color rojo.
	 */
